...
import { Menu, X, ClipboardList, LogOut, Calendar, LayoutDashboard, ChevronDown, ChevronRight, ArrowLeft, Check, User as UserIcon, Plus, Settings, TrendingUp, Search, Bell } from "lucide-react";
              ...
              <div className="relative" ref={profileMenuRef}>
                ...
                >
                  ...
                  <div className="hidden xl:block text-left min-w-0">
                    ...
                    <div className="text-xs text-ink-500 truncate">Doctor</div>
                  </div>
