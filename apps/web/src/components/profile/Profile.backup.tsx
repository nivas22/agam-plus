  ...
  return (
    <div className="min-h-screen bg-surface-canvas overflow-x-hidden">
      <div className="max-w-7xl mx-auto p-3 sm:p-4 md:p-6 lg:p-8 overflow-x-hidden">
        ...
        <div className="relative mb-4 sm:mb-6 md:mb-8 overflow-hidden rounded-2xl sm:rounded-3xl bg-brand-violet shadow-2xl">
          ...
          <div className="relative px-4 py-6 sm:px-6 sm:py-8 md:px-10 md:py-12">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-4 sm:gap-6 md:gap-8">
              ...
              <div className="relative group">
                <div className="absolute -inset-1 bg-brand-violet rounded-2xl sm:rounded-3xl blur opacity-75 group-hover:opacity-100 transition duration-300"></div>
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-status-open rounded-xl sm:rounded-2xl border-3 sm:border-4 border-white shadow-xl flex items-center justify-center animate-pulse">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                {'specialization' in profileData && (
                  <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-2 sm:px-5 sm:py-2.5 bg-status-warning/90 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-xl max-w-[280px] sm:max-w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="hidden lg:block space-y-6">
            ...
            <div className="group relative bg-surface-paper rounded-3xl shadow-lg border border-border overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
              <div className="absolute inset-0 bg-brand-violet/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative p-6">
                <div className="flex items-start gap-4">
                  <div className="w-14 h-14 rounded-2xl bg-brand-violet flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <Shield className="text-white" size={24} />
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-ink-900 mb-2">Account Security</h3>
                    <p className="text-sm text-ink-700 leading-relaxed mb-4">
                      Your account is protected. Contact administrator for changes.
                    </p>
                    <button className="inline-flex items-center gap-2 text-sm font-semibold text-brand-violet hover:text-brand-violet-hover transition-colors group/btn">
          ...
          />
            ...
            {'specialization' in profileData && (
              <>
                ...
                <div className="group relative bg-surface-paper rounded-2xl sm:rounded-3xl shadow-lg border border-border overflow-hidden hover:shadow-2xl transition-all duration-300">
                  <div className="absolute inset-0 bg-brand-violet/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="relative">
                    <div className="bg-brand-violet px-4 py-3 sm:px-6 sm:py-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 text-brand-violet mb-1">
                            ...
                            <span className="text-xs font-bold uppercase tracking-wider text-ink-500">Specialization</span>
                          </div>
                          <div className="text-sm sm:text-base font-semibold text-ink-900 break-words">
                            {profileData.specialization || <span className="text-ink-500 italic">Not set</span>}
                          </div>
                        </div>
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 text-brand-violet mb-1">
                            <FileText size={14} className="sm:w-4 sm:h-4 flex-shrink-0" />
                            <span className="text-xs font-bold uppercase tracking-wider text-ink-500">Qualification</span>
                          </div>
                          <div className="text-sm sm:text-base font-semibold text-ink-900 break-words">
                            {profileData.qualification || <span className="text-ink-500 italic">Not set</span>}
                          </div>
                        </div>
                        {profileData.experience !== undefined && (
                          <div className="space-y-2">
                            <div className="flex items-center gap-2 text-brand-violet mb-1">
                              ...
                              <span className="text-xs font-bold uppercase tracking-wider text-ink-500">Experience</span>
                            </div>
                            <div className="text-sm sm:text-base font-semibold text-ink-900 break-words">
                              {profileData.experience || <span className="text-ink-500 italic">Not set</span>}
                            </div>
                          </div>
                        )}
                      </div>
                ...
                <div className="group relative bg-surface-paper rounded-2xl sm:rounded-3xl shadow-lg border border-border overflow-hidden hover:shadow-2xl transition-all duration-300">
                  <div className="absolute inset-0 bg-status-open/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="relative">
                    <div className="bg-status-open px-4 py-3 sm:px-6 sm:py-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 sm:gap-3">
                          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-white/20 backdrop-blur-xl flex items-center justify-center">
                    ...
                    <div className="p-4 sm:p-6">
                      <div className="prose prose-sm max-w-none">
                        <p className="text-sm sm:text-base text-ink-700 leading-relaxed whitespace-pre-wrap">
                          {profileData.bio || (
                    ...
                    <div className="p-4 sm:p-6">
                      {isLoadingAvailability ? (
                        <div className="text-center py-6 sm:py-8">
                          <div className="animate-spin rounded-full h-8 w-8 sm:h-10 sm:w-10 border-b-2 border-brand-violet mx-auto mb-2 sm:mb-3"></div>
                          <p className="text-xs sm:text-sm text-ink-700 font-medium">Loading...</p>
                        </div>
                      ) : !availability || !availability.availability || availability.availability.length === 0 ? (
                        <div className="text-center py-6 sm:py-8">
                          <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-xl sm:rounded-2xl bg-surface-canvas flex items-center justify-center mx-auto mb-2 sm:mb-3">
                            <Clock className="w-6 h-6 sm:w-8 sm:h-8 text-ink-500" />
                          </div>
                          <p className="text-xs sm:text-sm text-ink-900 font-bold mb-1">No availability configured</p>
                          <p className="text-xs text-ink-500">Click Edit to set your schedule</p>
                        </div>
                      ) : (
                        <div className="space-y-1.5 sm:space-y-2">
                          {['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'].map((day) => {
                            ...
                            return (
                              <div key={day} className="flex items-start sm:items-center justify-between py-2 sm:py-2.5 px-2 sm:px-3 rounded-lg sm:rounded-xl hover:bg-surface-canvas transition-colors duration-150 gap-2">
                                <div className="flex items-center gap-2 sm:gap-3 min-w-[60px] sm:min-w-[80px] flex-shrink-0">
                                  <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full flex-shrink-0 ${hasSlots ? 'bg-brand-violet' : 'bg-border'}`}></div>
                                  <span className="text-xs sm:text-sm font-semibold text-ink-900">{day.slice(0, 3)}<span className="hidden sm:inline">{day.slice(3)}</span></span>
                                </div>
                                <div className="text-xs sm:text-sm font-medium text-right flex-1 min-w-0">
                                  {!hasSlots ? (
                                    <span className="text-ink-500 italic text-xs">Closed</span>
                                  ) : (
                                    <div className="flex flex-wrap justify-end gap-1 sm:gap-2">
                                      {daySlots.map((slot, idx) => (
                                        <span key={idx} className="inline-flex items-center gap-0.5 sm:gap-1 px-1.5 py-0.5 sm:px-2.5 sm:py-1 bg-brand-violet-soft border border-brand-violet/20 rounded-md sm:rounded-lg text-[10px] sm:text-xs font-semibold text-ink-700 whitespace-nowrap">
            ...
            <div className="group relative bg-surface-paper rounded-2xl sm:rounded-3xl shadow-lg border-2 border-status-danger/20 overflow-hidden hover:shadow-2xl transition-all duration-300">
              <div className="absolute inset-0 bg-status-danger/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              <div className="relative">
                <div className="bg-status-danger px-4 py-3 sm:px-6 sm:py-4">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-white/20 backdrop-blur-xl flex items-center justify-center">
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 sm:gap-4">
                    <div className="flex-1">
                      <h3 className="text-sm sm:text-base font-bold text-ink-900 mb-1.5 sm:mb-2">Delete Account</h3>
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 sm:gap-2 px-4 py-2 sm:px-6 sm:py-3 bg-status-danger hover:bg-status-danger-hover text-white text-xs sm:text-sm font-bold rounded-lg sm:rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl whitespace-nowrap"
                    >
